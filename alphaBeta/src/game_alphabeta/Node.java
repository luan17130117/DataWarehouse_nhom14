...
public class Node {
	...
	private int value;
	private List<Node> children = new ArrayList<Node>();// nếu nó là nốt nhánh thì có ds con
	...
	public static Comparator<Node> LabelComparatorRightToLeft = new Comparator<Node>() {
